...
def main():
    ...
    parser.add_argument('--hmm_cc', type=validate_positive, default=0.75, help='HMM coverage cutoff (Values 0 to 1 -- default is 0.75)')
    parser.add_argument('--iEvalue_co', type=validate_positive, default=0.01, help='iE-value score cutoff (default is 0.01)')
    parser.add_argument('--domain_cc', type=validate_positive, default=0.75, help='Domain coverage cutoff (Values 0 to 1 default is 0.75)')
    parser.add_argument('--unn_co', type=validate_positive, default=10, help='Length cutoff for detecting unannotated segments (default is 10)')
